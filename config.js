// Renseigne ces deux valeurs depuis Supabase > Project Settings > API.
// La clé « anon » est publique par conception : les données sont protégées par les règles RLS de schema.sql.
window.LE_CONFIG = {
